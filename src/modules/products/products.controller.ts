...
export class ProductsController {
  ...
  @ApiOperation({
    ...
    description:
      "Create a new product with image and digital file uploads (admins only)",
  })
  @ApiBearerAuth("JWT-auth")
    ...
    schema: {
      ...
      properties: {
        ...
        digital_file: {
          type: "string",
          format: "binary",
          description: "Digital file for delivery",
        },
      },
    },
  })
  ...
  @ApiOperation({
    ...
    description:
      "Update an existing product with optional file uploads (admins only)",
  })
  @ApiBearerAuth("JWT-auth")
  @ApiConsumes("multipart/form-data")
  @ApiParam({ name: "id", description: "Product ID" })
