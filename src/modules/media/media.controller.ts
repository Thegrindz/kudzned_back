...
export class MediaController {
  ...
  @ApiOperation({
    ...
    description:
      "Upload a single product image (JPEG, PNG, GIF, WebP, max 5MB)",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Upload multiple product images (max 10 files, JPEG, PNG, GIF, WebP, max 5MB each)",
  })
  @ApiBearerAuth("JWT-auth")
  @ApiConsumes("multipart/form-data")
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      "Upload a digital file for products (any file type, max 100MB)",
  })
  @ApiBearerAuth("JWT-auth")
  @ApiConsumes("multipart/form-data")
  @ApiBody({
