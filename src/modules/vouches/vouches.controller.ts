...
export class VouchesController {
  ...
  @ApiOperation({
    ...
    description:
      "Create a vouch/review for a product. Requires authentication.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Get rating statistics and vouch counts for a specific product",
  })
  ...
  async update(
    ...
    return this.vouchesService.update(
      id,
      req.user.id,
      updateVouchDto,
      proofImage,
  ...
  @ApiOperation({
    ...
    description:
      "Vote whether a vouch is helpful or not. Requires authentication.",
  })
  @ApiParam({ name: "id", description: "Vouch UUID" })
  async voteHelpfulness(
    ...
    return this.vouchesService.voteHelpfulness(
      id,
      req.user.id,
      vouchHelpfulnessDto,
    );
